...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/EasyStackView"
  ...
  # Or just: s.author    = "Elenion"
  # s.authors            = { "Elenion" => "stellanxu@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Elenion"
  ...
  s.source       = { :git => "http://EXAMPLE/EasyStackView.git", :tag => "#{s.version}" }
