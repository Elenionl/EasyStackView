...
- (void)render {
    ...
    if (self.dirty) {
        self.preferredSizeCache = [ESVCalculator scrollViewLayoutWithSize:self.bounds.size flexConfig:self arrangedConfigs:self.arrangedConfigs];
        self.contentSize = self.preferredSizeCache;
        self.dirty = false;
    }
}
